 ...
 * @property array $ownWeixinList;
 * @property array $weixins
 * @property array $adweixins
 */
class AdminUser extends User
{
    ...
    public function relations()
    {
        return array_merge(parent::relations(), array(
            'weixins' => array(self::HAS_MANY, 'AdminWeixin', 'user_id',
	            'condition' => 'weixins.state = ' . ADWEIXIN_STATE_ENABLED
	        ),
            'adweixins' => array(self::HAS_MANY, 'AdminAdWeixin', 'user_id',
	            'condition' => 'adweixins.state = ' . ADWEIXIN_STATE_ENABLED
	        ),
        ));
    }
    ...
    public function getOwnWeixinList()
    {
        return AdminWeixin::fetchOwnList($this->id);
    }
