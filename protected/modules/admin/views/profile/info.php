<div class="btn-toolbar">
    <a class="btn btn-small btn-danger" href="<?php echo url('admin/profile/resetpassword', array('id'=>$model->id));?>">重设密码</a>
    <a class="btn btn-small" href="<?php echo url('admin/profile/edit', array('id'=>$model->id));?>">编辑</a>
    <a class="btn btn-small" href="">刷新</a>
</div>
